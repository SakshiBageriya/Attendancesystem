      ...
      <div class="login-form">
        ...
        {{ csrf_field()}}
          ...
          <p>
            ...
            <input class="form-control" type="text" name="nm" placeholder="Username or Email" required>
          </p>
          <p>
            <label>Password<span>*</span></label>
            <input class = "form-control" type="password" name = "ps" placeholder="Password" required>
          </p>
          <p>
